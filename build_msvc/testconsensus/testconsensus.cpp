...
// cedicoin includes.
#include <..\src\script\cedicoinconsensus.h>
...
int main()
{
    std::cout << "cedicoinconsensus version: " << cedicoinconsensus_version() << std::endl;
    ...
    auto op0Result = cedicoinconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, cedicoinconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
