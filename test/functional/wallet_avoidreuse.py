...
class AvoidReuseTest(CedicoinTestFramework):
    ...
    def test_fund_send_fund_senddirty(self):
        '''
        Test the same as test_fund_send_fund_send, except send the 10 CEDI with
        the avoid_reuse flag set to false. This means the 10 CEDI send should succeed,
    ...
    def test_fund_send_fund_send(self):
        ...
        [0] sends 10 CEDI to A.
        [1] spends 5 CEDI from A. (leaving roughly 5 CEDI useable)
        [0] sends 10 CEDI to A again.
        [1] tries to spend 10 CEDI (fails; dirty).
        [1] tries to spend 4 CEDI (succeeds; change address sufficient)
        '''
