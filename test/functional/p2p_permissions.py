...
class P2PPermissionsTests(CedicoinTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].cedicoinconf, encoding="utf8") as f:
            newText=f.read().replace(old, new)
        with open(self.nodes[nodeid].cedicoinconf, 'w', encoding="utf8") as f:
            f.write(newText)
