...
"""Verify that starting cedicoin with -h works as expected."""

from test_framework.test_framework import CedicoinTestFramework
from test_framework.util import assert_equal

class HelpTest(CedicoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start cedicoin with -h for help text")
        ...
        self.log.info("Start cedicoin with -version for version information")
        ...
        self.log.info("Start cedicoind with -fakearg to make sure it does not start")
