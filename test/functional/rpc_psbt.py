...
class PSBTTest(CedicoinTestFramework):
    ...
    def run_test(self):
        # Create and fund a raw tx for sending 10 CEDI
        ...
        # feeRate of 0.1 CEDI / KB produces a total fee slightly below -maxtxfee (~0.05280000):
        ...
        # feeRate of 10 CEDI / KB produces a total fee well above -maxtxfee
