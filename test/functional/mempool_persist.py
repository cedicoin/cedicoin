...
By default, cedicoind will dump mempool on shutdown and
...
class MempoolPersistTest(CedicoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent cedicoind from writing mempool.dat to disk. Verify that `savemempool` fails")
