...
This document provides guidelines for internationalization of the Cedicoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `cedicoin_en.ts` remains unchanged.
