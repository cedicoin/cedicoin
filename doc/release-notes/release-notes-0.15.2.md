Cedicoin Core version *0.15.2* is now available from:

  <https://cedicoincore.org/bin/cedicoin-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in cedicoin-tx (TheBlueMatt)
