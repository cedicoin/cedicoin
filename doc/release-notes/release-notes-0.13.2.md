Cedicoin Core version 0.13.2 is now available from:

  <https://cedicoin.org/bin/cedicoin-core-0.13.2/>
...
- #8908 `4a974b2` Update cedicoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow cedicoin-tx to create v2 transactions (btcdrak)
