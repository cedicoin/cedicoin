Cedicoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/cedicoin/files/Cedicoin/cedicoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Cedicoin
...
New/changed settings (command-line or cedicoin.conf file)
--------------------------------------------------------
