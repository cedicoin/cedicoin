Download URL: https://sourceforge.net/projects/cedicoin/files/Cedicoin/cedicoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 CEDI fee schedule (users still pay 0.01 CEDI per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #cedicoin00 - #cedicoin99
