Cedicoin Core version 0.9.2.1 is now available from:

  https://cedicoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 CEDI to 0.01 CEDI
...
- Fix "Start cedicoin on system login"
