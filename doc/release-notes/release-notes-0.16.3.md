Cedicoin Core version 0.16.3 is now available from:

  <https://cedicoincore.org/bin/cedicoin-core-0.16.3/>
...
been discovered in Cedicoin Core versions 0.14.0 up to 0.16.2. It is recommended
...
### Miscellaneous
- #13655 `1cdbea7` cedicoinconsensus: invalid flags error should be set to `cedicoinconsensus_err` (afk11)
