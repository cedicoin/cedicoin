Cedicoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/cedicoin/files/Cedicoin/cedicoin-0.5.4/
...
http://gitorious.org/cedicoin/cedicoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Cedicoin-Qt notifications under Growl 1.3.
Increase required age of Cedicoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxCedicoin properly when installing Cedicoin-Qt over it. (Windows)
