Cedicoin Core version 0.9.4 is now available from:

  https://cedicoin.org/bin/0.9.4/
...
this update is incompatible with the Cedicoin system and could lead to consensus
forks.

Cedicoin Core released binaries from https://cedicoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~cedicoin/+archive/ubuntu/cedicoin
- A third-party or self-compiled Cedicoin Core

upgrade to Cedicoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
