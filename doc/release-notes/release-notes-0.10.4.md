Cedicoin Core version 0.10.4 is now available from:

  <https://cedicoin.org/bin/cedicoin-core-0.10.4/>
...
- #6953 `43c2789` Split cedicoin-tx into its own package
- #6953 `dfe0d4d` Include cedicoin-tx binary on Debian/Ubuntu
