Cedicoin Core version 0.16.1 is now available from:

  <https://cedicoincore.org/bin/cedicoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting cedicoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure cedicoind processes are cleaned up when tests end (sdaftuar)
