...
#ifndef CEDICOIN_TEST_SCRIPTNUM10_H
#define CEDICOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Cedicoin Core 0.10.0, for cross-comparison.
 */
public:
