...
static void SetupCedicoinTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " cedicoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  cedicoin-tx [options] <hex-tx> [commands]  Update hex-encoded cedicoin transaction\n" +
            "or:     cedicoin-tx [options] -create [commands]   Create hex-encoded cedicoin transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded cedicoin transaction
