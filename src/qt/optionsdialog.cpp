    ...
    mapper(nullptr)
{
    ...
    ui->cedicoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->cedicoinAtStartup);
    ...
    ui->cedicoinAtStartup->setToolTip(ui->cedicoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->cedicoinAtStartup->setText(ui->cedicoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openCedicoinConfButton->setToolTip(ui->openCedicoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new CedicoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->cedicoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openCedicoinConfButton_clicked()
{
