...
#ifndef CEDICOIN_QT_CEDICOINUNITS_H
#define CEDICOIN_QT_CEDICOINUNITS_H
...
/** Cedicoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class CedicoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit CedicoinUnits(QObject *parent);

    /** Cedicoin units.
      @note Source: https://en.cedicoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        CEDI,
...
typedef CedicoinUnits::Unit CedicoinUnit;

#endif // CEDICOIN_QT_CEDICOINUNITS_H
