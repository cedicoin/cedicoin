...
//! Entry point for CedicoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &CedicoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for CedicoinGUI tests.
void AppTests::guiTests(CedicoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &CedicoinGUI::consoleShown, this, &AppTests::consoleTests);
