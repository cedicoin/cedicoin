...
#ifndef CEDICOIN_QT_SPLASHSCREEN_H
#define CEDICOIN_QT_SPLASHSCREEN_H
 ...
 *
 * @note this is intentionally not a QSplashScreen. Cedicoin Core initialization
...
#endif // CEDICOIN_QT_SPLASHSCREEN_H
