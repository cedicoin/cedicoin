    ...
    platformStyle(_platformStyle)
{
    ...
    // normal cedicoin address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying cedicoin address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &CedicoinAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
