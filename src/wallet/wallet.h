...
#ifndef CEDICOIN_WALLET_WALLET_H
#define CEDICOIN_WALLET_WALLET_H
...
enum WalletFlags : uint64_t {
    ...
    //! cedicoin from opening the wallet, thinking it was newly created, and
 ...
 * change.
 *
 * The Cedicoin Core wallet was originally a collection of unrelated private
...
public:
     ...
     * on this cedicoin node, and set to 0 for transactions that were created
...
#endif // CEDICOIN_WALLET_WALLET_H
