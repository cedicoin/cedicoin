...
#ifndef CEDICOIN_CRYPTO_CHACHA_POLY_AEAD_H
#define CEDICOIN_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@cedicoin.
 *
 ...
 *
 * The chacha20-poly1305@cedicoin combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@cedicoin cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@cedicoin are relatively fast in
...
#endif // CEDICOIN_CRYPTO_CHACHA_POLY_AEAD_H
