...
#ifndef CEDICOIN_SCRIPT_STANDARD_H
#define CEDICOIN_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a cedicoin address
 */
...
/**
 * Generate a Cedicoin scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // CEDICOIN_SCRIPT_STANDARD_H
