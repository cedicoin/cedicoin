...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the cedicoin repository."
  exit 1
fi
...
# See https://github.com/cedicoin/cedicoin/issues/16064
...
echo 'When compiling cedicoind, run `./configure` in the following way:'
echo
