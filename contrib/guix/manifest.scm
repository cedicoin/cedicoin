...
(define* (make-cedicoin-cross-toolchain target
                                  #:key
...
desirable for building Cedicoin Core release binaries."
...
(packages->manifest
 (list ;; The Basics
       ...
       (make-cedicoin-cross-toolchain "i686-linux-gnu")
       (make-cedicoin-cross-toolchain "x86_64-linux-gnu")
       (make-cedicoin-cross-toolchain "aarch64-linux-gnu")
       (make-cedicoin-cross-toolchain "arm-linux-gnueabihf")
       ...
       (make-cedicoin-cross-toolchain "riscv64-linux-gnu"
