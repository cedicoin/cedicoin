# Bootstrappable Cedicoin Core Builds

This directory contains the files necessary to perform bootstrappable Cedicoin
Core builds.
...
- 24GB of free disk space on the partition that the Cedicoin Core git repository
  resides in
...
For a Cedicoin Core depends development environment, simply invoke
...
From the top of a clean Cedicoin Core repository:
...
To use dongcarl's substitute server for Cedicoin Core builds after having
